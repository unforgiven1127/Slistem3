...
$slistemQuery = 'select el.cp_pk as candidateID, e.date_create as createDate, e.content as note from event e inner join event_link el on el.eventfk = e.eventpk where e.type = "cp_history" and date_create >= "2017-01-01 00:00:00" and date_create < "2017-03-01 00:00:00" order by date_create asc';
