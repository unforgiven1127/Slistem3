...
switch(trim($_SERVER['SERVER_NAME']))
{
  case 'bcm.bulbouscell.com':
    ...
    define('CONST_DEV_EMAIL_2', 'promelot@bulbouscell.com');
    define('CONST_SHOW_MENU_BAR',1);
    define('CONST_VERSION', '3.1.0');
    define('CONST_DISPLAY_VERSION', 1);

    //---------------------------------------
    //Specific environment variables
    define('CONST_PHPMAILER_SMTP_DEBUG', false);
    define('CONST_PHPMAILER_DOMAIN', 'bulbouscell.com');
    ...
    define('CONST_MAIL_IMAP_LOG_PARAM_INBOX', '{mail.bulbouscell.com:993/debug/readonly/imap/ssl/novalidate-cert}inbox');
    define('CONST_MAIL_IMAP_LOG_PARAM_SENT', '{mail.bulbouscell.com:993/debug/readonly/imap/ssl/novalidate-cert}sent');


    define('CONST_AVAILABLE_LANGUAGE', 'en,jp,ph');
    define('CONST_DEFAULT_LANGUAGE', 'en');
    define('CONST_PAGE_USE_WINDOW_SIZE', false);
    define('CONST_SS_MAX_DOCUMENT_SIZE', 52428800);   //50MB
    define('CONST_SS_MAX_PROCESSABLE_SIZE', 2621440); //2.5MB
  ...
  case 'philippines.talentatlas.com':
    ...
    define('CONST_APP_NAME', 'Talent Atlas');
    ...
    //Specific environment variables
    define('CONST_PHPMAILER_SMTP_DEBUG', false);
    define('CONST_PHPMAILER_DOMAIN', 'talentatlas.com');
    define('CONST_PHPMAILER_EMAIL', 'talentatlas.com');
    define('CONST_PHPMAILER_DEFAULT_FROM', 'BCM - Notifier');
    define('CONST_PHPMAILER_ATTACHMENT_SIZE', 10485760);
    define('CONST_PHPMAILER_SMTP_HOST', 'mail.bulbouscell.com');
    define('CONST_PHPMAILER_SMTP_PORT', 465);
    ...
    define('CONST_DEFAULT_LANGUAGE', 'en');
    define('CONST_PAGE_USE_WINDOW_SIZE', false);
    define('CONST_SS_MAX_DOCUMENT_SIZE', 10485760); //10MB
    define('CONST_SS_MAX_PROCESSABLE_SIZE', 1048576); //1MB
  ...
  case 'stephane.bulbouscell.com':
    ...
    define('CONST_PHPMAILER_SMTP_DEBUG', false);
    define('CONST_PHPMAILER_DOMAIN', 'bulbouscell.com');
    define('CONST_PHPMAILER_EMAIL', 'bcm@bulbouscell.com');
    define('CONST_PHPMAILER_DEFAULT_FROM', 'BCM - Notifier');
    define('CONST_PHPMAILER_ATTACHMENT_SIZE', 10485760);
    define('CONST_PHPMAILER_SMTP_HOST', 'mail.bulbouscell.com');
    define('CONST_PHPMAILER_SMTP_PORT', 465);
  ...
  case 'online.globusjapan.com':
  case 'onlinetraining.bulbouscell.com':

    define('DB_NAME', 'globus_ot');
    define('DB_SERVER', '127.0.0.1');
    define('DB_USER', 'Globus');
    define('DB_PASSWORD', 'BQEjUUQyQvCjZwQd');
    define('CONST_WEBSITE', 'globus');
    define('CONST_APP_NAME', 'Globus Online Coaching');

    define('CONST_CRM_HOST', $_SERVER['SERVER_NAME'].'');
    define('CONST_CRM_DOMAIN', 'https://'.$_SERVER['SERVER_NAME'].'');
    define('CONST_CRM_MAIL_SENDER', 'no-reply@globusjapan.com');
    define('CONST_DEV_SERVER', 0);
    define('CONST_SQL_PROFILING', 0);

    define('CONST_DEV_EMAIL', 'promelot@bulbouscell.com');
    define('CONST_SHOW_MENU_BAR', 1);
    ...
    //Specific environment variables
    define('CONST_PHPMAILER_SMTP_DEBUG', false);
    define('CONST_PHPMAILER_EMAIL', 'online@globusjapan.com');
    define('CONST_PHPMAILER_DEFAULT_FROM', 'Globus - Notifier');
    define('CONST_PHPMAILER_ATTACHMENT_SIZE', 10485760);
    define('CONST_PHPMAILER_SMTP_HOST', 'smtp.gmail.com');
    define('CONST_PHPMAILER_SMTP_PORT', 465);
    define('CONST_PHPMAILER_SMTP_LOGIN', 'online');
    define('CONST_PHPMAILER_SMTP_PASSWORD', 'GlOnlin-734');
  ...
  case 'globus.devserv.com':
    ...
    //Specific environment variables
    define('CONST_PHPMAILER_SMTP_DEBUG', false);
    define('CONST_PHPMAILER_EMAIL', 'noreply@globusjapan.com');
    define('CONST_PHPMAILER_DEFAULT_FROM', 'Globus - Notification');
    define('CONST_PHPMAILER_ATTACHMENT_SIZE', 10485760);
    define('CONST_PHPMAILER_SMTP_HOST', 'mail.bulbouscell.com');
    define('CONST_PHPMAILER_SMTP_PORT', 465);
    define('CONST_PHPMAILER_SMTP_LOGIN', 'bcm@bulbouscell.com');
