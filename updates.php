...
$oMailBox = imap_open ('{'.CONST_PHPMAILER_SMTP_HOST_OLD.':'.CONST_MAIL_IMAP_PORT.'/imap/ssl/novalidate-cert}inbox', CONST_PHPMAILER_SMTP_LOGIN, CONST_PHPMAILER_SMTP_PASSWORD);
if($oMailBox === false)
{
	echo 'ERROR';
