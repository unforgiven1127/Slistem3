...
////ChromePhp::log($sQuery);
  ...
  function getSearchLogs($user_id)
  {
    ...
    $sQuery = "SELECT * FROM login_system_history lhs WHERE (lhs.table = 'quick_search' OR lhs.table = 'complex_search') AND lhs.userfk = '".$user_id."' ORDER BY lhs.login_system_historypk DESC LIMIT 20";
