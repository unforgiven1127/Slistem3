...
//      $asActions['ppas'][] = array('picture' => CONST_PICTURE_MENU_SEARCH, 'title' => 'Search documents', 'url' => 'javascript:;', 'option' => array('onclick' => $sAjax));
  ...
  */
  ...
  private function _displayForm()
  {
    ...
    $oForm->setFormParams('documentForm', true, array('action' => $sURL, 'submitLabel'=>'Save Document', 'inajax' => 'inajax', 'class' => 'single-upload-form' , 'noCancelButton' => 'noCancelButton','id'=>'addNewDocumentForm'));
  //  $oForm->setFormDisplayParams(array('noSubmitButton' => true));
    ...
    $oForm->addField('input', 'fileNameHidden',array('type' => 'hidden','id' => 'fileNameHidden', 'value' => '0'));
  ...
  */
  private function _saveDocument($pnPk = 0, $pbExternalFile = false, $pasDocData = array())
  {
    ...
    {
      $bSetLive = $this->_getModel()->setFileLive((int)$asDocument['live'], $this->cnPk);
      if(!$bSetLive)
