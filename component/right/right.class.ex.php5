...
class CRightEx extends CRight
{
  ...
  public function canAccess($psUid, $psAction = '', $psType = '', $pnPk = 0, $pasCallback = array())
  {
    ...
    if($psAction == 'ppcl' || $psAction == 'ppadd' || $psAction == 'csam' || $psAction == 'cdc' || $psAction == 'asrc' || $psAction == 'caca' || $psAction == 'msp' || $psAction == 'cms' || $psAction == 'msa' || $psAction == 'caas' || $psAction == 'cass' || $psAction == 'aao')
