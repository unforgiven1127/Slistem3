...
$(function () {
    ...
    var met_target = "20";
//-----------------------------------------------------------------------------------------//
    var users = " ;L.Fry |55|;J.Kovaliovas |15|;V.Maslyuk |12|;O.Rondos |11|;R.Pedersen |10|;P.Thai |10|;M.Moir |9|;C.Chen |8|;Y.Takagi |8|;K.Kapur |6|;S.D.V. |5|;P.Miles Harry |2|";
    users = users.split(';');
//-----------------------------------------------------------------------------------------//
    var count = "0;55;15;12;11;10;10;9;8;8;6;5;2";
    count = count.split(';');
