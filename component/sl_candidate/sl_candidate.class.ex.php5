...
//bunu ekleyelim contact work phone
      ...
      $poQB->addJoin('left', 'sl_contact', 'slcon', 'slcon.itemfk = scan.sl_candidatepk AND slcon.type = 2 AND slcon.sl_contactpk =(SELECT MAX(slcon2.sl_contactpk) FROM sl_contact slcon2)');
