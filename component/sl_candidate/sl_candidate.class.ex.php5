...
//bunu ekleyelim contact work phone
      ...
      $poQB->addJoin('left', 'sl_contact', 'slcon', 'slcon.itemfk = scan.sl_candidatepk AND slcon.date_create =(SELECT MAX(slcon2.date_create) FROM sl_contact slcon2 where slcon2.itemfk = scan.sl_candidatepk AND slcon2.type = 2)');
