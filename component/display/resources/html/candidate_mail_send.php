	...
	<table style="width:100%;" valign="top">
		<tr>
			...
			<td style='padding-top:15px;' align="left">
				<textarea contenteditable="true" spellcheck="true" required style="outline: none; width: 500px; height: 300px;" name="message" class="msgField" inajax="" id="message"><?php echo $signature; ?></textarea>
			</td>
		</tr>
	</table>
	<table>
