...
<table style='width:1000px; margin-top: 10px;' id='activeUsers' class="tableS">
    ...
    <?php foreach ($companyPositionList as $key => $position) {
        echo "<tr>";
            echo "<td class='positionInfo'><a onclick=\"view_position('https://".$server_name."/index.php5?uid=555-005&amp;ppa=ppav&amp;ppt=jd&amp;ppk=".$value."&amp;pg=ajx');\">".$position['sl_positionpk']."</a></td>";
