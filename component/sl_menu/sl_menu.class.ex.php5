...
class CSl_menuEx extends CSl_menu
{
  ...
  public function getMenuAction($psPosition)
  {
    ...
    //&nbsp;&nbsp;&nbsp;&nbsp;<a class="pipeLink" href="javascript:;" onclick="pipeCall(this, \''.$sURL.'&pipe_filter=in_play\');" title="Candidates in play, independently of their pitched status">In play</a><br />
     ...
     $sHTML.= '
      ...
      <li class="menu_section section_tab section_test" style="border-top: 1px solid #ddd; ">
  ...
  private function _getQuickSearchForm($pbInline = false, $pasSettings = array(), $pbHidden = false)
  {
    ...
    {
      $sHTML = $this->_oDisplay->getBlocStart('quickSearchContainer', array('class' => 'hidden', 'data-height' => 225, 'data-width' => 340, 'data-persistent' => 1, 'data-position' => '[15,85]', 'data-class' => 'noTitle','data-title' => 'Quick search...', 'data-draggable' => 0, 'data-resizable' => 0));
  ...
  private function _getQuickSearchCpForm($pbInline = false)
  {
    ...
    {
      $sHTML = $this->_oDisplay->getBlocStart('quickSearchContainerCp', array('style' => 'height:310px !important;','class' => 'hidden', 'data-height' => 160, 'data-width' => 340, 'data-persistent' => 1, 'data-position' => '[15,85]', 'data-class' => 'noTitle','data-title' => 'Quick search...', 'data-draggable' => 0, 'data-resizable' => 0));
