...
class CSl_menuEx extends CSl_menu
{
  ...
  private function _getQuickSearchCpForm($pbInline = false)
  {
    ...
    {
      $sHTML = $this->_oDisplay->getBlocStart('quickSearchContainerCp', array('style' => 'height:250px;','class' => 'hidden', 'data-height' => 160, 'data-width' => 340, 'data-persistent' => 1, 'data-position' => '[15,85]', 'data-class' => 'noTitle','data-title' => 'Quick search...', 'data-draggable' => 0, 'data-resizable' => 0));
