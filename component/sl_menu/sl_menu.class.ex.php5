    ...
    $sHTML.= '<div><div class="label '.$sLabelClass.'">company</div><div class="field">
     ...
     <div>
      ...
      <div><div class="label '.$sLabelClass.'">creator/owner</div><div class="field">
        <select style="background-color: #f0f0f0; border-color: #f0f0f0; border-bottom: 1px solid #ccc; color:gray; font-size:10px; height:16px;" name="owner" label="Owner" inajax="" id="owner">
           '.$options.'
        </select>
      </div></div>
